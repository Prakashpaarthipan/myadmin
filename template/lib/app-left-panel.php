      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <a href="/" class="br-menu-link with-sub">
            ...
            <span class="menu-item-label">My Work</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="./work.php" class="sub-link">My Work</a></li>
            <li class="sub-item"><a href="./index.php" class="sub-link">Sample Query</a></li>
            <li class="sub-item"><a href="/" class="sub-link">button</a></li>
          </ul>
        </li>
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub">
